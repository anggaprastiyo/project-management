          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input class="form-control {{ $errors->has('unit_code') ? 'is-invalid' : '' }}" type="text"
                     name="unit_code" id="unit_code" value="{{ old('unit_code', $user->unit_code) }}">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input class="form-control {{ $errors->has('unit_name') ? 'is-invalid' : '' }}" type="text"
                     name="unit_name" id="unit_name" value="{{ old('unit_name', $user->unit_name) }}">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input class="form-control {{ $errors->has('job_position_code') ? 'is-invalid' : '' }}" type="text"
                     name="job_position_code" id="job_position_code"
                     value="{{ old('job_position_code', $user->job_position_code) }}">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input class="form-control {{ $errors->has('job_position_text') ? 'is-invalid' : '' }}" type="text"
                     name="job_position_text" id="job_position_text"
                     value="{{ old('job_position_text', $user->job_position_text) }}">
