    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tickets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('assigne') ? 'is-invalid' : '' }}" name="assigne_id" id="assigne_id">
                    @foreach($assignes as $id => $entry)
                        <option value="{{ $id }}" {{ old('assigne_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('design_link') ? 'is-invalid' : '' }}" type="text" name="design_link" id="design_link" value="{{ old('design_link', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('related_ticket') ? 'is-invalid' : '' }}" name="related_ticket_id" id="related_ticket_id">
                    @foreach($related_tickets as $id => $entry)
                        <option value="{{ $id }}" {{ old('related_ticket_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
