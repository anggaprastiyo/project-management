        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary" href="{{ route('admin.comments.create') }}">
                    <i class="fa-fw nav-icon fas fa-plus"></i> {{ trans('global.add') }} {{ trans('cruds.comment.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-ticketComments">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.comment.fields.uuid') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-ticketComments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
