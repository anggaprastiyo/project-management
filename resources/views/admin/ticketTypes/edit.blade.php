    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ticket-types.update", [$ticketType->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('color') ? 'is-invalid' : '' }}" type="text" name="color" id="color" value="{{ old('color', $ticketType->color) }}" required>
                @if($errors->has('color'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('icon') ? 'is-invalid' : '' }}" type="text" name="icon" id="icon" value="{{ old('icon', $ticketType->icon) }}" required>
                @if($errors->has('icon'))
