        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.projects.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('team') ? 'is-invalid' : '' }}" name="team" id="team">
                        ...
                        @foreach(App\Models\Project::TEAM_SELECT as $key => $label)
                            <option
                                value="{{ $key }}" {{ old('team', 'internal') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('team'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('ticket_prefix') ? 'is-invalid' : '' }}" type="text"
                           name="ticket_prefix" id="ticket_prefix" value="{{ old('ticket_prefix', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('project_status') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('members') ? 'is-invalid' : '' }}"
                        ...
                        @foreach($members as $id => $member)
                            <option
                                value="{{ $id }}" {{ in_array($id, old('members', [])) ? 'selected' : '' }}>{{ $member }}</option>
                        @endforeach
                    </select>
