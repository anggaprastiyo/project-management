                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            ...
                            @foreach(App\Models\Project::TEAM_SELECT as $key => $item)
        ...
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                columns: [
                    ...
                    {data: 'name', name: 'name'},
                    {data: 'ticket_prefix', name: 'ticket_prefix'},
                    {data: 'project_owner_name', name: 'project_owner.name'},
                    {data: 'project_status_name', name: 'project_status.name'},
                    {data: 'type', name: 'type'},
